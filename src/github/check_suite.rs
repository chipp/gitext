    ...
    fn json_parsing() {
...

        {
            ...
            assert_eq!(
                ...
                Utc.ymd(2021, 9, 14).and_hms(11, 45, 36)
            );
            assert_eq!(
                check_suite.updated_at,
                Some(Utc.ymd(2021, 9, 14).and_hms(11, 50, 40))
            );
        }

        {
            ...
            assert_eq!(
                check_suite.created_at,
                Utc.ymd(2021, 10, 15).and_hms(9, 10, 21)
            );
            assert_eq!(
                check_suite.updated_at,
                Some(Utc.ymd(2021, 10, 15).and_hms(9, 13, 31))
            );
        }

        {
            ...
            assert_eq!(
                check_suite.created_at,
                Utc.ymd(2022, 1, 16).and_hms(10, 17, 24)
            );
            assert_eq!(
                check_suite.updated_at,
                Some(Utc.ymd(2022, 1, 16).and_hms(10, 17, 33))
            );
        }
    }
}
